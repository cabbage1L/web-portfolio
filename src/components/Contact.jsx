...
export default function Contact() {
    return (
        <section id="Contact" className="min-h-screen bg-black text-white flex flex-col justify-center items-center px-6 py-20 font-pixelify">
            ...
            <div className="mt-10">
                ...
                >
                    <h2 className="text-blue-300 text-6xl mb-6 tracking-widest">CONTACT</h2>

                    <p className="text-2xl leading-relaxed font-sans mb-2">
                    ...
                    <p className="text-2xl leading-relaxed font-sans mb-6">
                        iscokeeed@gmail.com
                    </p>
                    ...
                    >
                        ...
                        <h3 className="text-xl text-white mb-4">ATHIT</h3>
